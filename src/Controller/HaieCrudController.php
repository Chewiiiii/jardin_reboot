...
class HaieCrudController extends AbstractController
{
    ...
    #[Route('/new', name: 'app_haie_crud_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_haie_crud_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_haie_crud_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_haie_crud_delete', methods: ['POST'])]
